...
As you can see, R has really beautiful graphics, but we can make this chart look even better by using the `bbplot` package and also choosing our colour pallete using the `gameof thrones` package
